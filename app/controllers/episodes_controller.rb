class EpisodesController < ApplicationController
  before_action :authenticate_podcast!
  ...
  def update
    if @episode.update episode_params
      redirect_to podcast_episode_path(@podcast, @episode), notice: "Episode Updated"
    else
      render "edit"
    end
  end
  ...
  def require_permission
    ...
    if current_podcast != @podcast
      redirect_to root_path, notice: "Sorry, you aren't allowed to view that page"
    end
  end
